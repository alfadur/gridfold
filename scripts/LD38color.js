...
var LD38 = function (_, Kotlin) {
  ...
  function Level(container, levelMap, stageSize) {
    ...
    this.effectsNode = new PIXI.Graphics();
    this.effectsNode2 = new PIXI.Graphics();
    this.effectsNode3 = new PIXI.Graphics();
    ...
    var $receiver_4 = this.effectsNode;
    $receiver_4.beginFill(119);
    drawRect($receiver_4, this.levelBounds);
    $receiver_4.endFill();
    this.effectsNode.blendMode = PIXI.BLEND_MODES.EXCLUSION;
    this.container.addChild(this.effectsNode);
    var $receiver_5 = this.effectsNode2;
    $receiver_5.beginFill(11171584);
    drawRect($receiver_5, this.levelBounds);
    $receiver_5.endFill();
    this.effectsNode2.blendMode = PIXI.BLEND_MODES.MULTIPLY;
    this.container.addChild(this.effectsNode2);
    var $receiver_6 = this.effectsNode3;
    $receiver_6.beginFill(10061960);
    drawRect($receiver_6, this.levelBounds);
    $receiver_6.endFill();
    this.effectsNode3.blendMode = PIXI.BLEND_MODES.COLOR_DODGE;
    this.container.addChild(this.effectsNode3);
